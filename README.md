...
The complete workflow is documented in the Jupyter Notebook intern.ipynb, including dataset loading, preprocessing, PCA, KNN prediction, evaluation, and class-wise accuracy visualization.
